...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elite Wing · إيليت وينغ" },
      {
        name: "description",
        content:
          "Elite Wing · إيليت وينغ — integrated creative marketing, media, and events from Riyadh.",
      },
      { property: "og:site_name", content: "Elite Wing" },
      { property: "og:type", content: "website" },
      // Set once here — no page overrides it, so every share card gets an image.
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cairo:wght@400;600;700;800;900&family=Inter:wght@400;600;700;800;900&display=swap",
      },
    ],
  }),
